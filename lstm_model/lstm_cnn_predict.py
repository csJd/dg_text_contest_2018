...
tf.flags.DEFINE_string("meta_path","./runs/1532964507/checkpoints/model-2200.meta","meta_path")
tf.flags.DEFINE_string("model_path","./runs/1532964507/checkpoints/model-2200","model_path")
